...
namespace Microsoft.ClearScript.V8.SplitProxy
{
    ...
    {
        private static readonly IV8SplitProxyNative instance = Impl.Instance;

        #region Nested type: Impl

        private sealed class Impl : IV8SplitProxyNative
        {
            public static readonly IV8SplitProxyNative Instance = new Impl();
