rem sample startup test script

set clr = host.lib("mscorlib", "System", "System.Core")
set System = clr.System

set TestObject = host.type("Microsoft.ClearScript.Test.ConsoleTestObject", "ClearScriptConsole")
