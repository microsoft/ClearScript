...
echo Downloading V8 ...
svn checkout http://v8.googlecode.com/svn/trunk/ v8 >nul
...
if errorlevel 1 goto Error1
cd v8-ia32
third_party\python_26\python build\gyp_v8 -Dtarget_arch=ia32 -Dcomponent=shared_library -Dv8_use_snapshot=false >nul
if errorlevel 1 goto Error2
devenv /build "%mode%|Win32" tools\gyp\v8.sln >nul
if errorlevel 1 goto Error2
cd ..
...
if errorlevel 1 goto Error1
cd v8-x64
third_party\python_26\python build\gyp_v8 -Dtarget_arch=x64 -Dcomponent=shared_library -Dv8_use_snapshot=false >nul
if errorlevel 1 goto Error2
devenv /build "%mode%|x64" tools\gyp\v8.sln >nul
if errorlevel 1 goto Error2
cd ..\..
